...
Update of the following table: 2024-08-09 18:38 CEST

| File | Number of hashes |
| ---- | ---------------- |
| full-hash-md5-\*.txt | 4046 |
| full-hash-sha1-\*.txt | 284 |
| full-hash-sha256-\*.txt | 60115 |
...
| alienvault-ragnar-locker | [link](https://otx.alienvault.com/pulse/65bca8fcbe62297d71b47c33) | Paylods of RagnarLocker Ransomware |
...
- suggest I add **another** source of malicious hahs.
